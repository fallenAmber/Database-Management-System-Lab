...
ALTER PROC sp_showItemDetails
AS
BEGIN
SELECT "Category"=item_category,"Total number of items"=sum(item_qoh),"Average Price"=cast(avg(item_price)as decimal(10,2)) FROM ITEM group by item_category
END
...
exec sp_showItemDetailsP 'device','50'
...
exec sp_showItemDetailsL 'device',8.0